...
<div class="container mt-5">
        ...
        <section>
            ...
            <article class="border rounded border-dark" style="margin-bottom: 10px;">
                <header>
                    ...
                    <a href="/update/{{$type->id}}" class="btn btn-primary border rounded float-right" type="submit">
                        <i class="material-icons d-xl-flex justify-content-xl-center"
    ...
    <div class="d-xl-flex text-center">
        <form action="/type" class="text-center border rounded" method="POST" id="form">
            ...
            <div class="form-group">
                <input class="form-control" type="number" min="0" max="2147483647" id="quantity" name="quantity"
                    placeholder="Quantity..." required></input>
            </div>
            <div class="form-group">
                <input class="form-control" type="number" min="0" max="2147483647" step="0.01" id="price" name="price"
